...
-- The existing function is made invoker-safe immediately. Tasks 5 and 6
-- replace its body and signatures with the canonical validated implementations.
ALTER FUNCTION public.procesar_venta(jsonb) SECURITY INVOKER;

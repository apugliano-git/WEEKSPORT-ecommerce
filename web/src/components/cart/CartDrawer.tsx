            ...
            <form onSubmit={handleCheckout} className="flex flex-col gap-3">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-[#23232A] text-white placeholder-gray-500 border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#F400A1] transition-shadow"
                />
              </div>
              <button 
                type="submit"
                className="w-full bg-[#F400A1] hover:bg-[#D000A0] text-white font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-2 transition-colors active:scale-[0.98]"
              >
